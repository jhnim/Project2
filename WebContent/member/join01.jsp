...
<%@ include file="../include/global_head.jsp" %>
 ...
 function chk(){
	 //바이네임은 중복체크가 가능하기때문에 리턴값이 배열이어서 [0]으로 선언
	 var box = document.getElementsByName('agreement1')[0];
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<a onclick="check();"><p style="text-align:center; margin-bottom:20px"><img src="../images/btn01.gif" onclick="chk()" />&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
