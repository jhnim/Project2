	...
	<form action="../member/LoginProcMap.jsp" name="MainForm" id="MainForm" method="post" onsubmit="return fnLogin(this);">
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td><input type="text" name="id" value="<%=(save.length() == 0) ? "" : save %>" 
			...
			<tr>
				...
				<td><input type="text" name="pass" class="login_input" /></td>
			</tr>
		</table>
		<p>
			<!--  
			...
			-->
			<label><input type="checkbox" name="id_save" id="id_save"
					<%if(save.length() != 0){ %> 
						checked="checked" 
					<%} %> />
					<img src="../images/login_tit03.gif" alt="저장" /></label>				
...
<%}else{ //로그인 후%>
						...
						<p style="padding:10px 0px 10px 10px">
							<span style="font-weight:bold; color:#333;">
								<%=NAME %>님,</span> 반갑습니다.<br />로그인 하셨습니다.
						</p>
...
<%} %>
				...
				<!-- 디자인이 깨지지 않는 범위 내에서 글자를 잘라서 출력될 수 있도록 하기 -->
